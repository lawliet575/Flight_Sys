...
-- TRIGGER FOR PILOT
CREATE OR REPLACE TRIGGER PILOT_BEFORE_INSERT
...
BEGIN
    ...
    :NEW.TOTAL_PRICE := CALCULATE_PRICE(:NEW.FLIGHT_ID, :NEW.F_CLASS_ID);
...
--BOOKINGS
INSERT INTO BOOKINGS (PASSENGER_ID, FLIGHT_ID, F_CLASS_ID, BOOKING_DATE, SEAT_NO)
