    ...
    <div className="home-container d-flex flex-column justify-content-between">
      <nav class="navbar navbar-expand-lg pt-3" style={{textShadow: "0 0 15px #5c5c5c"}}>
        <div class="container-fluid ps-5 pe-3">
          <a class="navbar-brand text-light fw-bold fs-3 ms-3" href="#" style={{ letterSpacing: "2px" }}>FlyEase<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-send mx-2 fw-bold" viewBox="0 0 16 16">
          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item"><a href="#" class="nav-link fw-semibold text-light fs-5 px-3"><button className="btn btn-success fw-semibold" onClick={handleSignIn}>Sign In</button></a></li>
